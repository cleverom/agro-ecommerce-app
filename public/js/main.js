(function ($) {
  ...
  /*--
	...
	-----------------------------------*/
  let blogPostSlider = $('.blog-image-gallery');
  ...
  /*--
	...
	-----------------------------------*/
  let catSlider = $('.category-slider-container');
  catSlider.slick({
    arrows: true,
    autoplay: false,
    draggable: false,
  ...
  /*--
	...
	-----------------------------------*/
  let multisaleSlider = $('.multisale-slider-wrapper');
  ...
  /*--
	...
	-----------------------------------*/
  let relatedSlider = $('.related-product-slider-wrapper');
  relatedSlider.slick({
    arrows: true,
    autoplay: false,
    dots: false,
  ...
  /*--
	...
	-----------------------------------*/
  let saleSingleSlider = $('.sale-single-product-container');
  saleSingleSlider.slick({
    ...
    slidesToShow: 1,
    prevArrow:
      '<button type="button" class="slick-prev"><span class="arrow_carrot-left"></span></button>',
    nextArrow:
      '<button type="button" class="slick-next"><span class="arrow_carrot-right"></span></button>',
    responsive: [
      {
        breakpoint: 1200,
        settings: {
  ...
  $('.small-image-slider-single-product a').on('click', function (e) {
    ...
    let $thisParent = $(this).closest('.product-image-slider');
    let $href = $(this).attr('href');
    $thisParent
      .find('.small-image-slider-single-product a')
      .removeClass('active');
    $(this).addClass('active');

    $thisParent
      .find('.product-large-image-list .tab-pane')
      .removeClass('active show');
    $thisParent
      .find('.product-large-image-list ' + $href)
  ...
  /*--
		Image Popup
		-----------------------------------*/
  let imagePopup = $('.big-image-popup');
