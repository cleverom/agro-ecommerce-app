...
router.post('/login', function (req, res) {
    ...
    if (errors.length > 0) {
        ...
        users_1.default.findOne({ email: email }).then(function (user) { return __awaiter(void 0, void 0, void 0, function () {
            var match;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        return [2 /*return*/, res.redirect('/my-account')];
...
router.post('/reg', function (req, res) {
    ...
    if (errors.length > 0) {
        ...
        users_1.default.findOne({ email: email }).then(function (user) {
            if (user) {
                ...
                var newUser_1 = new users_1.default({
